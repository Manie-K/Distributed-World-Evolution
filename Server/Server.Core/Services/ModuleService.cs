    ...
    public class ModuleService : IModuleService
    {
        ...
        public void CreateModule(CreateModuleDTO dto)
        {
            using (var dbContext = new ApplicationDBContext())
            {
                ...
                (
                    dto.Official, dto.Name, dto.Damage, dto.Agression, dto.ReproductionNeed, dto.MaxHunger, dto.MaxHealth, dto.Type, dto.GraphicalRepresentationID, dto.BehaviourIDs.ToArray()
                );
