...
namespace Client.UI.CreateLobby
{
    public class ModulesImageDisplay
    {
        ...
        public void InitializeImages(ContentManager contentManager)
        {
            ...
            Images[2] = contentManager.Load<Texture2D>("UI/CreateLobby/Modules_Images/Rabbit_Brown_Image");
            Images[3] = contentManager.Load<Texture2D>("UI/CreateLobby/Modules_Images/White_Rabbit_Image");

            Images[4] = contentManager.Load<Texture2D>("UI/CreateLobby/Modules_Images/Plant1_Image");
            Images[5] = contentManager.Load<Texture2D>("UI/CreateLobby/Modules_Images/Plant2_Image");
