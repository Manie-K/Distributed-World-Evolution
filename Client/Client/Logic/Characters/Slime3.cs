...
namespace Client
{
    ...
    {
        public Slime3(Vector2 position, int maxHealth, Color color)
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(AssetsManager.GetInstance().GetCharacterTexture((int) am.ActiveAnimation, 8), GetPosition(), GetSourceRectangle(), Color.White);
